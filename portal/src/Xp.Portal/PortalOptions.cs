...
public sealed class PortalOptions
{
    ...
    /// <summary>
    /// Where the "Download launcher" button leads. Empty is the normal case: the site then hands out
    /// the launcher of <see cref="LauncherChannel"/> from the repository itself, through
    /// /download/launcher. Set this only to send players somewhere else entirely.
    /// </summary>
    ...
    /// <summary>Channel of the launcher itself: what the download button on the entrance screen gives out.</summary>
    public string LauncherChannel { get; set; } = "launcher-stable";
